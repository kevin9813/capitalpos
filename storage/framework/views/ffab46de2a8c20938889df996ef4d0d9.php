<div>
    ...
    <!--[if BLOCK]><![endif]--><?php if($showModalTurno): ?>
        ...
        <div 
            ...
            <div class="flex items-center justify-between mb-3">
                ...
                <div class="flex gap-3">
                    <button
                        ...
                        <?php echo e($payment_method === 'Efectivo' 
                    ...
                    <button
                        ...
                        class="px-4 py-2 rounded-lg border text-lg font-semibold
                        <?php echo e($payment_method === 'Transferencia' 
                            ? 'bg-blue-600 text-white border-blue-700' 
                            : 'bg-gray-200 dark:bg-gray-700 dark:text-white'); ?>">
                    ...
                    <button
                        ...
                        class="px-4 py-2 rounded-lg border text-lg font-semibold
                        <?php echo e($payment_method === 'Banco' 
                            ? 'bg-blue-600 text-white border-blue-700' 
                            : 'bg-gray-200 dark:bg-gray-700 dark:text-white'); ?>">
            ...
            <div class="overflow-x-auto rounded-lg shadow">
                <table class="min-w-full border border-gray-200 dark:border-gray-700">
                    ...
                    <tbody>
                        <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr wire:key="item-<?php echo e($key); ?>" class="border-t border-gray-200 dark:border-gray-700">
                                <td class="px-4 py-2"><?php echo e($loop->iteration); ?></td>
                                <td class="px-4 py-2"><?php echo e($item['name']); ?></td>
                                <td class="px-4 py-2 text-center"><?php echo e(strtoupper($item['unit_type'])); ?></td>
        
                                <td class="px-4 py-2 text-right">
                                    <!--[if BLOCK]><![endif]--><?php if($item['unit_type'] === 'kl'): ?>
                                        <input type="number" step="0.01" min="0"
                                            wire:change="actualizarPeso('<?php echo e($key); ?>', $event.target.value)"
                                    ...
                                    <?php else: ?>
                                        <input type="number" min="1"
                                            wire:change="actualizarCantidad('<?php echo e($key); ?>', $event.target.value)"
                                ...
                                <td class="px-4 py-2 text-right">$<?php echo e(number_format($item['price'], 0, ',', '.')); ?></td>
                                <td class="px-4 py-2 text-right font-semibold">$<?php echo e(number_format($item['subtotal'], 0, ',', '.')); ?></td>
        
                                <td class="px-4 py-2 text-center">
                                    <button wire:click="eliminarItem('<?php echo e($key); ?>')" class="text-red-500 hover:text-red-700"
            ...
            <div class="mt-6 flex justify-end">
                <p class="text-sm text-gray-600 dark:text-gray-400">
                    Ítems: <span class="font-semibold"><?php echo e(count($items)); ?></span>
                </p>&nbsp;&nbsp;
                <div class="text-right">
                    <p class="text-lg text-gray-700 dark:text-gray-200 font-semibold">Total:</p>
                    <p class="text-2xl font-bold text-blue-600 dark:text-blue-400">$<?php echo e(number_format($total, 0, ',', '.')); ?></p>
                </div>
            </div>
            ...
            <div class="mt-6 flex justify-between items-center">
                <div>
                    <p class="text-sm text-gray-600 dark:text-gray-400">
                        Turno abierto: <?php echo e($shift->opened_at->format('d/m/Y h:i A')); ?>

                    </p>
                </div>
                <div class="flex items-center space-x-6">
                    <p class="text-sm text-gray-600 dark:text-gray-400">
                        N.Facturas: <?php echo e($facturas->count()); ?>

                    </p>
                    <p class="text-sm text-gray-600 dark:text-gray-400">
                        T.Vendido: $ <?php echo e(number_format($facturas->sum('total'))); ?>
            ...
            <div class="table-wrapper max-h-80 overflow-y-auto rounded border dark:border-gray-700">
                <table class="table-sticky min-w-full border border-gray-200 dark:border-gray-700">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="p-2 text-center"><?php echo e($index + 1); ?></td>
                            <td class="p-2 text-center"><?php echo e(str_pad($factura->id, 8, '0', STR_PAD_LEFT)); ?></td>
                            <td class="p-2"><?php echo e($factura->created_at->format('d/m/Y h:i A')); ?></td>
                            <td class="p-2"><?php echo e($factura->payment_method); ?></td>
                            <td class="p-2 text-right">$ <?php echo e(number_format($factura->total)); ?></td>
                            <td class="p-2 text-center"><?php echo e($factura->status); ?></td>
                        </tr>
    ...
    <!--[if BLOCK]><![endif]--><?php if($modalCerrarTurno): ?>
        <div class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
            ...
            <div class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-xl w-96">
                ...
                <div class="space-y-1 text-gray-400">
                    ...
                    <p>T. Ventas: <span class="text-gray-200 font-semibold">$ <?php echo e(number_format($facturas->sum('total'))); ?></span></p>
                </div>                
                <hr>
...
[$__name, $__params] = $__split('expenses', []);

$__html = app('livewire')->mount($__name, $__params, 'lw-3598528701-0', $__slots ?? [], get_defined_vars());
...
</div><?php /**PATH /var/www/html/resources/views/livewire/billing.blade.php ENDPATH**/ ?>