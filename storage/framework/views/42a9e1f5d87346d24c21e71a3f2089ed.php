    ...
    <div class="mt-4">
                ...
                <table class="w-full">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b dark:border-gray-700">
                            ...
                            <td class="p-2"><?php echo e($u->usuario); ?></td>
                            <td class="p-2"><?php echo e($u->role ? $u->role->name : 'Sin rol'); ?></td>
                            <td class="p-2"><?php echo e(($u->status == 1) ? "Activo" : "Inactivo"); ?></td>
                            <td class="p-2 text-right">

                                <button 
                                    wire:click="edit(<?php echo e($u->id); ?>)"
                ...
                <div class="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
                    <div class="bg-white text-black dark:bg-gray-900 dark:text-white rounded-xl shadow-lg w-full max-w-md p-6">
                        ...
                        <h2 class="text-xl font-semibold mb-4">
                            <?php echo e($userIdBeingEdited ? 'Editar usuario' : 'Crear usuario'); ?>
        ...
        <div x-show="tab === 'permisos'">
            ...
            <!--[if BLOCK]><![endif]--><?php if($selectedRole): ?>
                ...
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group => $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="grid grid-cols-2 gap-3 p-1">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <span class="text-lg text-gray-300 dark:text-gray-200"><?php echo e($permission->name); ?></span>
                        </div>
...
<?php /**PATH /var/www/html/resources/views/livewire/users.blade.php ENDPATH**/ ?>