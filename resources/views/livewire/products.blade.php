        ...
        <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div class="bg-white text-black dark:bg-gray-900 dark:text-white rounded-xl shadow-lg w-full max-w-md p-6">
                ...
                <h2 class="text-xl font-semibold mb-4">
                    {{ $ProductIdBeingEdited ? 'Editar Producto' : 'Crear Producto' }}
                </h2>
            ...
            <tbody>
                @forelse ($products as $p)
                    <tr class="border-t border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-900 transition">
                        ...
                        <td class="p-3">{{ $p->unit_type }}</td>
                        <td class="p-3">${{ number_format($p->price, 2) }}</td>
                        <td class="p-3">{{ $p->tax_percent }}%</td>
                        <td>
                            <button 
         ...
         <div class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg w-full max-w-md p-6">
                ...
                <div class="flex justify-end mt-4 space-x-2">
                    ...
                    <button wire:click="deleteConfirmed({{$confirmingDeleteId}})"
